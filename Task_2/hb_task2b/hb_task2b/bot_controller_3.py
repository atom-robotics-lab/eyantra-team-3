...
#         self.subscription = self.create_subscription(Goal,'/hb_bot_3/goal',self.goalCallBack, 10)    # Callback function to handle received message  # QoS profile, here it's 10 which means a buffer size of 10 messages
        
#         self.subs=self.create_subscription(Pose2D, '/detected_aruco_3',self.aruco_feedback_cb, 10)

#         self.lw=self.create_publisher(Wrench, '/hb_bot_3/left_wheel_force', 10)
#         self.rw=self.create_publisher(Wrench, '/hb_bot_3/right_wheel_force', 10)
#         self.fw=self.create_publisher(Wrench, '/hb_bot_3/rear_wheel_force', 10)
...
#         chasis_velocity = math.sqrt(abs(vel_x*vel_x) + abs(vel_y*vel_y))
#         chasis_velocity = abs(chasis_velocity) * 0.70
...
#             hb_controller.err_x = (hb_controller.bot_1_x[count] - 260.0) - hola_x                 
#             hb_controller.err_y = (260.0 - hb_controller.bot_1_y[count]) - hola_y                                              
#             hb_controller.err_theta = hb_controller.bot_1_theta - hola_theta      

#             print( "GOAL: ", hb_controller.bot_1_x[count] - 260, " , ", hb_controller.bot_1_y[count] - 260, " , ", hb_controller.bot_1_theta, "\n" ) 
